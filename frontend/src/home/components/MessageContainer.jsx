        ...
        {selectedConversation === null ? (
          ...
          <>
            ...
            <div className='w-full rounded-full flex items-center bg-white'>
              <input value={sendData} onChange={handelMessages} required id='message' type='text'  placeholder='Enter your messaage' 
              className='w-full bg-transparent outline-none px-4 rounded-full text-black'/>
              <button type='submit'>
...
//     const sound = new Audio(notify);
//     sound.play();
//     setMessage((prevMessages) => [...prevMessages, newMessage]); // ✅ proper update
//   };
...
//   };
// }, [socket, setMessage]); // ✅ messages removed from deps
