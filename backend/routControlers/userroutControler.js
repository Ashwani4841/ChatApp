...
export const userRegister = async (req, res) => {
    try {
        ...
        const profileBoy = profilepic || `https://api.dicebear.com/8.x/initials/svg?seed=${username}`;
        const profileGirl = profilepic || `https://api.dicebear.com/8.x/initials/svg?seed=${username}`;
